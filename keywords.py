...
#####################################################
### TODO Board:
# TODO: Add Maximum marginal relevance to the merger for better keywords.
...
class KeywordMetadataAdder(MetadataAdder):
    ...
    # NOTE: from parent class, we invoke this directly because it's callable / use `process_nodes`